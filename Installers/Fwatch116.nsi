...
VIAddVersionKey "Comments" "Scripting extension for the Operation Flashpoint: Resistance 1.96 and ArmA: Cold War Assault 1.99 Legacy"
...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.ofp-faguss.com/fwatch"
...
Section "OFP Aspect Ratio 2.09" SectionOFPAR
	DetailPrint "==== Installing OFP Aspect Ratio 2.09 ==== "
	...
	; Create list of mods
	nsArray::Split modfolders @airwolf|@ECP|@ffsx85|@ffsx2007|@GRAA|@JF|@MCM-SLX|@OFrP_Mod|@wgl5|@WW2_MP|@ww4mod25|bin|finmod|Res|x_vte|ffur2006|CSLA|V.A.N.O.mod|@LoBo|@Reforger4|@SLX|W39|WW1Mod|@TuPaS| |
	...
	IfFileExists $INSTDIR\@LoBo 0 +3
	SetOutPath "$INSTDIR\@LoBo\bin\"
	File "OFPAspectRatio\@LoBo\Resource.cpp"
	
	IfFileExists $INSTDIR\@Reforger4 0 +3
	SetOutPath "$INSTDIR\@Reforger4\bin\"
	File "OFPAspectRatio\@Reforger4\Resource.cpp"
	
	IfFileExists $INSTDIR\@SLX 0 +3
	SetOutPath "$INSTDIR\@SLX\bin\"
	File "OFPAspectRatio\@SLX\Resource.cpp"
	
	IfFileExists $INSTDIR\V.A.N.O.mod 0 +3
	SetOutPath "$INSTDIR\V.A.N.O.mod\bin\"
	File "OFPAspectRatio\V.A.N.O.mod\Resource.cpp"
	
	IfFileExists $INSTDIR\W39 0 +3
	SetOutPath "$INSTDIR\W39\bin\"
	File "OFPAspectRatio\W39\Resource.cpp"	
	
	IfFileExists $INSTDIR\WW1Mod 0 +3
	SetOutPath "$INSTDIR\WW1Mod\bin\"
	File "OFPAspectRatio\WW1Mod\Resource.cpp"
...
Function AspectSelection
	...
	StrCmp $0 "3.55556" 0 +3
		StrCpy $AR_STRING "32_9"
		StrCpy $AR_STRING2 "32:9"
	...
	${NSD_CreateRadioButton} 2% 70% 40% 6% "32:9"
		Pop $radio7
		${NSD_AddStyle} $radio7 ${WS_GROUP}
		${NSD_OnClick} $radio7 RadioChange
	...
	${If} "$cfgName" == "ArmAResistance.cfg"
		StrCpy $R8 "ArmA: Resistance 2.01 detected (file ArmAResistance.cfg exists in the folder)"
	${ElseIf} "$cfgName" == "ColdWarAssault.cfg"
		StrCpy $R8 "ArmA: Cold War Assault 1.99 detected (file ColdWarAssault.cfg exists in the folder)"
	${Else}
...
Function RadioChange
	...
	${If} $1 == $radio1
		...
		${NSD_SetState} $radio7 ${BST_UNCHECKED}
	${EndIf}
	${If} $1 == $radio2
		StrCpy $AR_STRING "5_4"
