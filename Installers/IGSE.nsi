; NSIS Script for In-Game Script Editor installation v1.3
...
VIAddVersionKey "ProductName" "IGSE Installer"
...
VIAddVersionKey "FileDescription" "Install IGSE script"
...
!define MUI_FINISHPAGE_LINK_LOCATION "http://www.ofp-faguss.com/files/In-Game Script Editor.pdf"
...
; Copy IGSE =======================================================
	...
	SetOutPath "$INSTDIR\In-Game-Script-Editor\"
	File /r "In-Game-Script-Editor\*"

  
  

; Copy IGSE demo missions =========================================
	...
	IfFileExists "$INSTDIR\Users\*.*" getUser 0
		nouser:
		DetailPrint "NO USER"
		CreateDirectory "$INSTDIR\Missions\IGSE"
		SetOutPath "$INSTDIR\Missions\IGSE\"
		File /r "missions\*"
